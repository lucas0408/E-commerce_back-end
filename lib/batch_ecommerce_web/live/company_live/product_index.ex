    ...
    <div class="max-w-7xl mx-auto px-4 py-20">
      ...
      >
        ...
        <div class="flex space-x-8">
          ...
          <.link patch={~p"/companies/#{@company_id}/products/new"} color="primary" class="font-bold text-white bg-indigo-600 rounded-lg p-1 hover:bg-indigo-800 hover:scale-105">
            Adicionar Produto
          </.link>
        </div>
      </div>
